...
public class KiemKhoChiTiet {
	...
	public KiemKhoChiTiet(KiemKho kiemKho, int maKiemKho, SanPhamVaDichVu sanPhamVaDichVu, int maDichVu,
	...
	public String toString() {
		return "KiemKhoChiTiet [kiemKho=" + kiemKho + ", maKiemKho=" + maKiemKho + ", sanPhamVaDichVu="
